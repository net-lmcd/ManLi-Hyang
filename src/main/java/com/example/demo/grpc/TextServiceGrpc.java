...
public final class TextServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<TextRequest,
      TextResponse> getProtoTestMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "protoTest",
      requestType = TextRequest.class,
      responseType = TextResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<TextRequest,
      TextResponse> getProtoTestMethod() {
    io.grpc.MethodDescriptor<TextRequest, TextResponse> getProtoTestMethod;
  ...
  public static abstract class TextServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void protoTest(TextRequest request,
  ...
  public static final class TextServiceBlockingStub extends io.grpc.stub.AbstractStub<TextServiceBlockingStub> {
    ...
    /**
     */
    public TextResponse protoTest(TextRequest request) {
  ...
  public static final class TextServiceFutureStub extends io.grpc.stub.AbstractStub<TextServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<TextResponse> protoTest(
        TextRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_PROTO_TEST:
          serviceImpl.protoTest((TextRequest) request,
              (io.grpc.stub.StreamObserver<TextResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class TextServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return Prototest.getDescriptor();
    }
